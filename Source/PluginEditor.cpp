                                    ...
                                    bool shouldDrawButtonAsDown)
{
    if (auto* pb = dynamic_cast<PowerButton*>(&toggleButton))
    {
        ...
        // if on then one colour, if off then another
    ...
    {
        auto color = toggleButton.getToggleState() ? juce::Colour(0u, 172u, 1u) : juce::Colours::dimgrey;
        g.setColour(color);
